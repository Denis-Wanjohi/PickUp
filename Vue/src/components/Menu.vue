<template>
    ...
    <div class="card flex justify-center">
        ...
        <div  @click="visible = true" class="flex bg-blue-900 rounded px-2 py-1 font-bold text-white" >
            <p v-if="store.state.user.data != null">{{username(store.state.user.data[0].name)}}</p>
