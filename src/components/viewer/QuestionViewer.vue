    ...
    <div class="mt-3">
        ...
        <div v-if="question.type === 'select'">
            ...
            >
                ...
                <option v-for="(option, index) in question.data.options" :key="option.uuid" :value="option.text">{{ option.text }}</option>
            </select>
        </div>
        <div v-else-if="question.type === 'radio'">
            ...
            >
                <input type="radio"
                    ...
                    :value="option.text"
                    @change="emits('update:modelValue',$event.target.value)"
                    class="focus:ring-indigo-500 my-2 h-4 w-4 text-indigo-600 border-gray-300">
        ...
        <div v-else-if="question.type === 'textarea'">
            <textarea 
                :value="modelValue"
                @input="emits('update:modelValue',$event.target.value)"
                class="mt-1 w-full min-h-[100px] focus:ring-indigo-500 focus:border-indigo-500 block shadow-sm sm:text-sm border-gray-300 rounded-md"    
            ></textarea>
...
function onChnageCheckbox($event){
