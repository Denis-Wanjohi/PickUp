        ...
        <div class="w-3/4 shadow shadow-black pb-10">
            ...
            <div v-if="cart.confirmed">
                <div class="text-center mt-10">
                    <p class="font-mono">2. Enter the MPESA number that will make the payment</p>
                </div>
                <form v-if="cart.number == ''" @submit.prevent="setNumber" class="flex justify-evenly place-items-center">
                ...
                <p v-else class="flex gap-3  py-5 font-bold  mx-auto justify-center text-sm"><span class="text-md font-thin">MPESA number:</span> {{ cart.number }} <CheckIcon class="w-5 bg-green-500 rounded-full border-2 border-black"></CheckIcon> </p>

            </div>
            
            <div v-if="cart.number != ''">
                <div class="text-center mt-10">
                    <p class="font-mono">3. Enter the MPESA confirmation code</p>
                </div>
                <form  @submit.prevent="confirmationCode" class="flex justify-evenly place-items-center">
